...
public:
	...
	void objModelOut();
	void draw(Shader& shader, glm::mat4 model, glm::mat4 view, glm::mat4 projection,glm::vec3 CameraPos, glm::vec3 LightPos,glm::vec3 LightInfo, GLfloat LightIntensity);
